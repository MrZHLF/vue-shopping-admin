<template>
  <div>
    <el-container
      style="position: absolute;top: 55px;bottom: 0;right: 0;left: 0;"
    >
      <el-header class="d-flex align-items-center border-bottom">
        ...
        <el-button
          ...
          >批量删除</el-button
        >
        <el-button type="success" size="medium" @click="opemAlbumModel(false)"
          >创建相册</el-button
        >
        <el-button type="warning" size="medium" @click="uploadModel = true"
          >上传图片</el-button
        >
      </el-header>
      <el-container>
