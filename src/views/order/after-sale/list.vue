<template>
  ...
  >
    ...
    >
      ...
      <el-table-column prop="username" label="商品清单"></el-table-column>
      <el-table-column prop="price" label="订单金额"></el-table-column>
      <el-table-column prop="name" label="收货信息"></el-table-column>
      <el-table-column prop="content" label="买家"></el-table-column>
      <el-table-column prop="code" label="交易状态"></el-table-column>
