<template>
	<div class="bg-white px-3" style="margin: -20px;margin-top: -1rem;margin-bottom: 0!important;">
		<el-tabs v-model="tabIndex" @tab-click="handleClick"><el-tab-pane v-for="(tab, index) in tabbars" :key="index" :label="tab.name"></el-tab-pane></el-tabs>
		<button-search ref="buttonSearch" placeholder="要搜索的订单编号" @search="searchEvent">
			...
			<template #form>
				...
				<el-form inline ref="form" :model="form" label-width="80px">
					<el-form-item label="订单编号" class="mb-0"><el-input v-model="form.no" size="mini" placeholder="要搜索的订单编号"></el-input></el-form-item>
					...
					<el-form-item label="收货人" class="mb-0"><el-input v-model="form.name" size="mini" placeholder="要搜索的收货人"></el-input></el-form-item>
					<el-form-item label="手机号" class="mb-0"><el-input v-model="form.phone" size="mini" placeholder="要搜索的手机号"></el-input></el-form-item>
					<el-form-item>
		...
		<el-table :data="tableData" border class="mt-3" style="width: 100%" @selection-change="handleSelectionChange">
			...
			<el-table-column prop="title" width="350" label="商品">
				<template slot-scope="scope">
					...
					<div class="media" v-for="(item, index) in scope.row.order_items" :key="index">
						<img class="mr-3 border-top py-2" :src="item.goods_item.cover" style="width: 60px;height: 60px;" />
			...
			<el-table-column align="center" label="支付方式">
				<template slot-scope="scope">
					...
					<span class="badge badge-primary" v-else-if="scope.row.payment_method === 'alipay'">支付寶支付</span>
			...
			<el-table-column align="center" width="180" label="交易状态">
				<template slot-scope="scope">
					...
					<div>
						收货状态:
						<span class="badge" :class="scope.row.ship_status === 'pending' ? 'badge-success' : 'badge-secondary'">
		...
		<el-dialog title="订单发货" :visible.sync="shipModel">
			<el-form ref="ruleForm" :model="shipForm" label-width="80px">
				...
				<el-form-item label="快递单号" prop="express_no"><el-input type="text" v-model="shipForm.express_no"></el-input></el-form-item>
			</el-form>
		...
		<el-dialog title="导出数据" :visible.sync="exportModel" width="40%">
			<el-form ref="ruleForm" :model="exportForm" label-width="80px">
				<el-form-item label="快递公司" prop="tab">
