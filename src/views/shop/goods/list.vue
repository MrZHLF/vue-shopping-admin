<template>
  <div class="bg-white px-3" style="margin: -20px;margin-top: -1rem;margin-bottom: 0!important;">
    <el-tabs v-model="tabIndex" @tab-click="handleClick">
        <el-tab-pane v-for="(tab,index) in tabbars" :key="index" :label="tab.name">
				...
				<template #form>
					...
					<el-form inline ref="form" :model="form" label-width="80px">
						<el-form-item label="商品名称" class="mb-0">
							<el-input v-model="form.name" size="mini" placeholder="要搜索的商品名称"></el-input>
						</el-form-item>
						<el-form-item label="商品编码" class="mb-0">
							<el-input v-model="form.code" size="mini" placeholder="要搜索的商品编码"></el-input>
						</el-form-item>
						<el-form-item label="商品类型" class="mb-0">
							<el-select v-model="form.type" placeholder="要搜索的商品类型" size="mini">
								<el-option label="区域一" value="shanghai"></el-option>
								<el-option label="区域二" value="beijing"></el-option>
							</el-select>
						</el-form-item>
						<el-form-item label="商品分类" class="mb-0">
							<el-input v-model="form.category" size="mini" placeholder="要搜索的商品分类"></el-input>
						</el-form-item>
						<el-form-item >
			...
			<el-table
			  :data="tableData[index].list" border class="mt-3"
			  ...
			  <el-table-column
				...
				label="商品状态">
				<template slot-scope="scope">
					<el-button type="success" @click="scope.row.ischeck=1" plain>审核通过</el-button>
					<el-button type="danger" @click="scope.row.ischeck=2" plain class="ml-0 mt-0">审核拒绝</el-button>
